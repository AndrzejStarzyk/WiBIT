...
from day_parameters import DayParameters
...
def parse_text(text: str):
    ...
    if len(matches) == 1:
        parse_period_text(doc[matches[0][1]:matches[0][2]], day_parameters)

    day_parameters.assume_missing_info()
    return day_parameters


def parse_period_text(text: str, day_parameters: DayParameters):
...
if __name__ == '__main__':
    parse_period_text("29 do 6 grudnia", DayParameters())
