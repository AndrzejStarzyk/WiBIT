This folder contains simple Python scripts which can be used to familiarize with options available in popular APIs contains information about tourist attractions:  
